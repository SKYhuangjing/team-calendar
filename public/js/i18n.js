...
export const DICT = {
  zh: {
    ...
    'label.team': '团队', 'label.homeTeam': '所属团队',
    ...
    'auth.unlock': '解锁',
    'auth.adminUnlockTitle': '超管解锁',
    'auth.teamUnlockTitle': '解锁团队：{name}',
    'auth.unlockDashboardTitle': '解锁控制台',
    'auth.noTeamsNeedUnlock': '暂无团队需要解锁',
    'auth.bannerText': '当前视图为只读模式（未解锁团队：{name}）',
    'auth.bannerLink': '点击解锁编辑',
    'auth.adminPassword': '超管密码',
    'auth.teamPassword': '团队操作密码',
    'auth.wrongPassword': '密码错误',
    'auth.unlocked': '已解锁团队',
    'auth.badgeUnlocked': '🔓 已解锁 {n}',
    'auth.adminUnlocked': '已超管解锁',
    'auth.locked': '已锁定',
    'auth.lock': '锁定',
    'auth.lockTitle': '锁定（退出登录，需重新解锁才能编辑）',
    'auth.lockHint': '编辑需先解锁',
    'auth.admin': '超管',
    'auth.teamPwdTitle': '团队操作密码',
    'auth.teamPwdHint': '为团队设置操作密码后，团队成员输入密码即可解锁编辑本团队数据；未设密码的团队仅超管可编辑。「全部团队」视图的编辑需超管密码。',
    'auth.pwdSet': '已设密码', 'auth.pwdNone': '未设密码',
    'auth.setPwd': '设密码', 'auth.changePwd': '改密码', 'auth.clearPwd': '清除',
    'auth.setPwdTitle': '设置「{name}」操作密码',
    'auth.teamPasswordAgain': '再次输入密码',
    'auth.needPwd': '请输入密码', 'auth.pwdMismatch': '两次输入不一致',
    'auth.pwdSaved': '已保存操作密码', 'auth.pwdCleared': '已清除操作密码',
    'auth.confirmClear': '清除后该团队将无需密码即可编辑（仍受超管约束），确认？',
    ...
    'settings.navPeople': '人员', 'settings.navProjects': '项目', 'settings.navData': '数据', 'settings.navArchive': '归档', 'settings.navPasswords': '团队密码', 'settings.archiveTitle': '归档数据', 'settings.emptyArchive': '暂无归档数据',
  ...
  en: {
    ...
    'label.team': 'Team', 'label.homeTeam': 'Home team',
    ...
    'auth.unlock': 'Unlock',
    'auth.adminUnlockTitle': 'Admin Unlock',
    'auth.teamUnlockTitle': 'Unlock team: {name}',
    'auth.unlockDashboardTitle': 'Unlock Dashboard',
    'auth.noTeamsNeedUnlock': 'No teams need unlocking',
    'auth.bannerText': 'View is read-only (Team: {name} is locked)',
    'auth.bannerLink': 'Unlock to edit',
    'auth.adminPassword': 'Admin password',
    'auth.teamPassword': 'Team operation password',
    'auth.wrongPassword': 'Wrong password',
    'auth.unlocked': 'Team unlocked',
    'auth.badgeUnlocked': '🔓 {n} unlocked',
    'auth.adminUnlocked': 'Admin unlocked',
    'auth.locked': 'Locked',
    'auth.lock': 'Lock',
    'auth.lockTitle': 'Lock (sign out; re-unlock required to edit)',
    'auth.lockHint': 'Unlock to edit',
    'auth.admin': 'Admin',
    'auth.teamPwdTitle': 'Team Operation Passwords',
    'auth.teamPwdHint': 'Set a password for a team so its members can unlock and edit that team\'s data. Teams without a password are admin-editable only. Editing in the "All teams" view requires the admin password.',
    'auth.pwdSet': 'Password set', 'auth.pwdNone': 'No password',
    'auth.setPwd': 'Set password', 'auth.changePwd': 'Change', 'auth.clearPwd': 'Clear',
    'auth.setPwdTitle': 'Set "{name}" operation password',
    'auth.teamPasswordAgain': 'Re-enter password',
    'auth.needPwd': 'Please enter a password', 'auth.pwdMismatch': 'Passwords do not match',
    'auth.pwdSaved': 'Operation password saved', 'auth.pwdCleared': 'Operation password cleared',
    'auth.confirmClear': 'Clearing removes the password (editing still subject to admin). Continue?',
    ...
    'settings.navPeople': 'People', 'settings.navProjects': 'Projects', 'settings.navData': 'Data', 'settings.navArchive': 'Archive', 'settings.navPasswords': 'Team Passwords', 'settings.archiveTitle': 'Archived', 'settings.emptyArchive': 'No archived items',
